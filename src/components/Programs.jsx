...
export default function Programs() {
  return (
    <section id="programs" className="w-full overflow-hidden px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
      <div className="mx-auto w-full max-w-[1320px]">
        <FadeIn><SectionHeading>Our Programs</SectionHeading></FadeIn>
        <div className="mt-6 sm:mt-8">
          <AutoSlider duration={30} gap="gap-4 sm:gap-5 lg:gap-6">
            {programs.map((program, i) => (
              <FadeIn key={program.id} delay={i * 0.1} className="w-[84vw] max-w-[360px] shrink-0 sm:w-[330px] lg:w-[350px]">
