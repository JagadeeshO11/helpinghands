      ...
      <div className="relative z-[60] w-full border-b border-[#04458F]/20 bg-white text-[#061D49]">
        <div className="flex min-h-10 w-full items-stretch sm:min-h-11">
          ...
          <div className="flex min-w-0 flex-1 items-center overflow-hidden bg-white">
            <div className="flex h-full shrink-0 items-center gap-1 border-y border-[#04458F]/20 bg-white px-1.5 py-1 text-[9px] font-bold sm:gap-2 sm:px-2.5 sm:text-xs">
            ...
            <div className="news-marquee-viewport bg-white">
              <div className="news-marquee-track">
                {[...NEWS_ITEMS, ...NEWS_ITEMS].map((item, index) => (
                  <span key={`${item}-${index}`} className="inline-flex shrink-0 items-center text-[9px] text-[#061D49] transition-colors hover:text-[#04458F] sm:text-sm">
                    <span>{item}</span>
                    <span className="mx-4 text-[#04458F] sm:mx-8">•</span>
                  </span>
                ))}
              </div>
            </div>
          ...
          <a href="tel:+919818398199" className="flex shrink-0 items-center gap-1 bg-gradient-to-r from-[#196823] to-[#5E922C] px-2 text-[9px] font-semibold text-white transition-all hover:text-[#EF9A0A] sm:gap-2 sm:px-5 sm:text-sm lg:px-6">
            <FaPhoneAlt className="size-2.5 sm:size-3" aria-hidden="true" />
            <span className="hidden min-[400px]:inline">+91 98183 98199</span>
