    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <Routes>
        ...
        <Route path="/*" element={<><Header /><Routes>
          ...
          <Route path="/about/legal-terms" element={<AboutSubpage />} />
          ...
          <Route path="/resources/photos" element={<ResourcePage />} />
          <Route path="/resources/videos" element={<ResourcePage />} />
          <Route path="/resources/achievements-awards" element={<ResourcePage />} />
          <Route path="/resources/press-stories" element={<ResourcePage />} />
